...
<section class="content-header">
      <h1>
        Danh Sách Email Nhận Dự Án Mới 
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh Sách Email Nhận Dự Án Mới </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ListDataEmail" class="table table-bordered table-striped" style="width:100%;">
                <thead>
                <tr>
                  <th>STT</th>
                  <th>Email  </th>
                ...
                <tbody>
                    <?php $stt=0; ?>
                @foreach($data_email as $iteam_email) 
                <?php $stt++ ?>
                  <tr>
                    <td>{!! $stt !!}</td>
                    <td>{!! $iteam_email->email !!}</td>
                    <td>{!! $iteam_email->created_at !!}</td>
                    <td>
                    <a href="{{ route('admin.blog.edit.getTypeBlog',$iteam_email->id) }}" class="Modal edit" data-catalog="{!!$iteam_email->id!!}" > <i class="fa fa-edit" ></i> </a>
                        <button type="button" class="Modal eye" > <i class="fa fa-eye"  ></i> </button>
                        <button type="button" class="Modal trash" data-catalog="{!!$iteam_email->id!!}" data-toggle="modal"  data-target="#ModalDelete"  > <i class="fa fa-trash" ></i> </button>
                    </td>
                  </tr>
                @endforeach
                </tbody>
