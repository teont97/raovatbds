      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <form action="{{ route('admin.address.edit.posthuyen',$data_edit['id']) }}" method="POST">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <option value="{{ $data_edit->tinh['id']}}">{{ $data_edit->tinh['name'] }} </option>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" value="{{ $data_edit['name']}}"  name="txthuyen" > 
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
