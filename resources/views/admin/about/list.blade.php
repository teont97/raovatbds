      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="ListAbout" class="table table-bordered table-striped" style="width:100%;">
                <thead>
                <tr>
                  <th>STT</th>
                ...
                <?php $stt++ ?>
                  <tr>
                    <td>{!! $stt !!}</td>
                    <td>{!! $iteam_about->content !!}</td>
                    <td>{!! $iteam_about->images !!}</td>
            ...
            <div class="box-footer clearfix group-btn-footer">
                    <a href="{{ route('admin.blog.getTypeBlog') }}" class="btn btn-success" > Thêm Mới  </a>
             </div>
          </div>
          <!-- /.box -->
        </div>
