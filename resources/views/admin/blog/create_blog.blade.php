        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Viết Bài Blog Mới </h3>
            </div>
            <form action="{{ route('admin.blog.postBlog') }}" method="POST" enctype="multipart/form-data" >
            ...
            <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                             <label>Tóm Tắt </label>
                            <textarea  class="form-control"  name="short"  style="height:100px;"> </textarea>
                        </div>
                        <div class="form-group">
                            <label for="sel1">Danh Mục</label>
                            <select class="form-control" id="id_parent" name="slparent">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="upload" name="fileupload">
                        </div>
                        <div class="form-group">
                                <label>Từ Khóa</label>
