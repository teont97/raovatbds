    ...
    <div class="overlay">
        <div class="container">
            <div class="breadcrumb-area">
                <h1>Agent Grid sidebar</h1>
                <ul class="breadcrumbs">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Agent Grid sidebar</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-5 col-sm-5 col-xs-2">
                            <h4>
                                ...
                                <span class="hidden-xs">Agent Grid</span>
                            </h4>
                        </div>
                        <div class="col-lg-6 col-md-7 col-sm-7 col-xs-10 cod-pad">
                            <div class="sorting-options">
                                ...
                                <a href="agent-listing-row-sidebar.html" class="change-view-btn"><i class="fa fa-th-list"></i></a>
                                <a href="agent-listing-grid-sidebar.html" class="change-view-btn active-view-btn"><i class="fa fa-th-large"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
